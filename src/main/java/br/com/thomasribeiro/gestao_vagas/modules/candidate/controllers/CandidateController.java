...
import br.com.thomasribeiro.gestao_vagas.modules.candidate.services.ApplyJobCandidateService;
import br.com.thomasribeiro.gestao_vagas.modules.candidate.services.CandidateService;
import br.com.thomasribeiro.gestao_vagas.modules.candidate.services.ListAllJobsByFilterService;
...
public class CandidateController {
    ...
    @PreAuthorize("hasRole('CANDIDATE')")
    @Operation(summary = "Inscrição do candidato para uma vaga", description = "Essa função é responsável por realizar a incrição do candidato em uma vaga")
    @SecurityRequirement(name = "jwt_auth")
